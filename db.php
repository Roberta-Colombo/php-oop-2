...
$art5->setWeight(20, 'gr');
// var_dump($art5);
$products[] = $art5;

$art6 = new Toy(6, 'CleverDog', 'Soft Toy', $categoryDog, 3.20, './img/bone2.jpg', 'in stoffa', 'colore: viola e giallo');
$art6->setWeight(90, 'gr');
// var_dump($art6);
$products[] = $art6;
